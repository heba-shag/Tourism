...
<ul class="">
  ...
  <div class="contactInfoCenter">
            <div class="info-panel">
                <h4 class="location-title">ِAleppo</h4>
                <span>Derma</span>
                ...
                <i class="fa-solid fa-envelope"></i>
                  <div class="card-content">
                    <h6 class="content-title">email:</h6><a class="email link" href="mailto:yourname@example.com">example@gmail.ocm</a>
                  </div>
                </div>
                <div class="location-card  ">
                <i class="fa-solid fa-phone-volume"></i>
                  <div class="card-content">
                    <h6 class="content-title">phone:</h6><a class="tel link" href="tel:0123456789">0923456789</a>
                  </div>
                </div>
              </div>
              <div id="map-container" class="gps">
              <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d103019.38695312371!2d37.2309870754332!3d36.20654492740922!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sar!2s!4v1691614309823!5m2!1sar!2s" width="600" height="300"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
        </div>
      ...
      listItem.forEach((li) => {
        ...
        li.addEventListener('click', () => {  
            ...
            contactInfoList.forEach(contactInfo => {
                if (contactInfo.querySelector("span").textContent.includes(x)) {
...
function removeActive() {
    listItem.forEach((li) => {
        ...
        this.classList.add("activeli");
            ...
            const ratingStars = documenCt.querySelector('.rating-star');
