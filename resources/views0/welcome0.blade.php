...
<div class="register-container">
    ...
    <!-- book section -->
    {{-- <form method="POST" action="{{ route('ph') }}" enctype="multipart/form-data">
        @csrf
        <div>
            <label for="centername">Username:</label>
        ...
        <button type="submit">Inssert Image</button>
    </form> --}}
    <!-- end book section -->
    ...
    <div class="modalOverlay">
        ...
        <div class="box-container">
            ...
            <div class="box">
                {{-- <img src="{{asset($center->image)}}" alt=""> --}}
            ...
            <div class="content">
                ...
                <h3><i class="fas fa-map-marker-alt"></i>{{$center->site}}</h3>
                    ...
                    <a href="{{route('cen' , $center->id)}}" class="btn">see more</a>
                </div>
            </div>
            @endforeach
        </div>
